	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<center><h1 class="page-header" style="color:blue;";>CUSTOMER MANAGEMENT SYSTEM</h1> </center>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-default"><a href="/cms">Save changes</a></button>
	      </div>
	      </form> 
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="removeMemberModal">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	        <button type="button" class="btn btn-primary" id="removeBtn"><a href="/cms">Save changes</a></button>
	      </div>
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
	  ...
	  <div class="modal-dialog" role="document">
		...
		<form class="form-horizontal" action="php_action/update.php" method="POST" id="updateMemberForm">	      
	      ...
	      <div class="modal-body">
	        ...
	        <div class="edit-messages"></div>
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
			    <label for="editItems" class="col-sm-2 control-label">Items</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="editItems" name="editItems" placeholder="Items">
			    </div>
			  </div>
				<div class="form-group">
			    <label for="editPrice" class="col-sm-2 control-label">Price</label>
			    <div class="col-sm-10">
	      ...
	      <div class="modal-footer editMemberModal">
	        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	        <button type="submit" class="btn btn-secondary"><a href="/cms">Save changes</a></button>
	      </div>
	      </form>
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
